...
public class SceneManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        List<VisualElement> bichos = root.Q("bichos").Children().ToList();
        bichos.ForEach(b => {
        ...
        bichosContainers = root.Q<VisualElement>("bichos").Children().ToList();
        antes = root.Q<Button>("ante");
        despues = root.Q<Button>("despues");
